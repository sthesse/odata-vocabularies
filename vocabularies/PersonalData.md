...
[RelatedDataCategoryID](PersonalData.xml#L262)|\[String\]|<a name="RelatedDataCategoryID"></a>Annotation with the assignment of multiple data categories to one entity<br>The annotation value is an array of strings, enabling the assignment of multiple data categories to one entity. The strings must adhere to the format of an ORD ID corresponding to the concept name "dataCategory" introduced herein (refer to ORD Specification \| Open Resource Discovery).
